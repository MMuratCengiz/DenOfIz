...
public:
    ...
    DZ_EXAMPLES_API explicit FreeCamera( float aspectRatio, float fovY = DirectX::XM_PIDIV4, float nearZ = 0.01f, float farZ = 500.0f );
    ...
    DZ_EXAMPLES_API void HandleEvent( const DenOfIz_Event &ev );
    DZ_EXAMPLES_API void SetPosition( const DirectX::XMVECTOR &position );
    DZ_EXAMPLES_API void SetFront( const DirectX::XMVECTOR &front );
    DZ_EXAMPLES_API void SetRotation( const DirectX::XMVECTOR &quaternion );
