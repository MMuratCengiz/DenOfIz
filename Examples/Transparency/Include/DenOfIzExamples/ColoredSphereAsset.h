...
namespace DenOfIz
{
    ...
    public:
        DZ_EXAMPLES_API ColoredSphereAsset( DenOfIz_LogicalDevice device, DenOfIz_BatchResourceCopy batchResourceCopy, XMFLOAT4 color );
        DZ_EXAMPLES_API ~ColoredSphereAsset( );
