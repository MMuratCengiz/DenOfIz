...
void
VulkanUtilities::InitStagingBuffer( const VulkanContext *context, vk::Buffer &buffer, VmaAllocation &allocation, const void *data, const uint64_t &size )
{
    ...
    vmaCreateBuffer( context->Vma, reinterpret_cast<VkBufferCreateInfo *>(&stagingBufferCreateInfo), &stagingAllocationInfo, reinterpret_cast<VkBuffer *>(&buffer), &allocation, nullptr );
...
{
    RunOneTimeCommand( context, [&]( const vk::CommandBuffer &commandBuffer )
    {
