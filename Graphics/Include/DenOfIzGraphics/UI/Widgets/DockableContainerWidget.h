...
namespace DenOfIz
{
	...
	class DockableContainerWidget : public Widget
	{
		...
		ClayDockableContainerRenderData m_renderData;
	...
	public:
		DZ_API DockableContainerWidget( Clay *clay, uint32_t id, DockingManager *dockingManager, const DockableContainerStyle &style = {} );
	...
	public:
		DZ_API DockingManager( Clay *clay );
