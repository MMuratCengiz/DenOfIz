...
namespace DenOfIz
{
    ...
    public:
        ...
        virtual void                SetRootConstantsData( uint32_t binding, const ByteArrayView &data )                              = 0;
        ...
        virtual IResourceBindGroup *SrvArray( const uint32_t binding, const TextureResourceArray &resources )                         = 0;
