...
namespace DenOfIz
{
    ...
    public:
        VulkanShaderBindingTable( VulkanContext *context, const DenOfIz_ShaderBindingTableDesc &desc );
    ...
    private:
        ...
        void                   EncodeData( void *entry, VulkanShaderLocalData *data ) const;
    };
} // namespace DenOfIz
