...
namespace DenOfIz
{
    ...
    public:
        DX12ShaderLocalData( DX12Context *context, const DenOfIz_ShaderLocalDataDesc &desc );
        void Begin( ) override;
    ...
    private:
        void EncodeTexture( uint32_t index, const ITexture *texture );
        void EncodeBuffer( uint32_t index, const IBuffer *buffer );
