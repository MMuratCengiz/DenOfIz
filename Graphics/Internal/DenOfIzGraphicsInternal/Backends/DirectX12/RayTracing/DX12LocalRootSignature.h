...
namespace DenOfIz
{
    ...
    public:
        DX12LocalRootSignature( DX12Context *context, const DenOfIz_LocalRootSignatureDesc &desc );
        ...
        [[nodiscard]] bool                 HasBinding( DenOfIz_ResourceBindingType type, uint32_t bindingIndex ) const;
